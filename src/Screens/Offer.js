...
import { Event_lang, Home_lang, Offer_lang } from '../Utils/Constants/Language_content'
...
const Offer = ({ navigation }) => {
  ...
  const Sub_category_API = async () => {
    ...
    const SubCategory_url = `${API_url.SubCategory}?limit=10&page=1&type=offer`
  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:Colors.Primary_color}}>
        ...
        {/* header */}
        <View>
          <Custom_Header name={Offer_lang.Offer[lang]} nav={navigation} />
        </View>
